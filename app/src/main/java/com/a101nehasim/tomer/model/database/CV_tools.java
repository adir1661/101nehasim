...
//                       -------CV---to---SELLER-----
    public static Seller ContentValuesToSeller(ContentValues contentValues) {
        ...
        if (contentValues.containsKey(Finals_101.Seller.ID))
            user.setId(contentValues.getAsLong(Finals_101.Seller.ID));
        if (contentValues.containsKey(Finals_101.Seller.EMAIL))
            user.setEmail(contentValues.getAsString(Finals_101.Seller.EMAIL));
        if (contentValues.containsKey(Finals_101.Seller.CELLPHONE))
            user.setCellphone(contentValues.getAsString(Finals_101.Seller.CELLPHONE));
        if (contentValues.containsKey(Finals_101.Seller.PRICE))
            user.setPrice(contentValues.getAsLong(Finals_101.Seller.PRICE));
        if (contentValues.containsKey(Finals_101.Seller.NAME))
            user.setName(contentValues.getAsString(Finals_101.Seller.NAME));
